#!/usr/bin/env python3
"""v4（1386 题）逐题生成 3-seed 学生预测 + 与教师做 McNemar 配对检验。"""
import json
import os
import sys
...
TEST = os.path.join(ROOT, "data/cn_dental_v4/test.jsonl")
TEACHER = os.path.join(ROOT, "teachers/deepseek_v4flash_cn_dental_v4_test.jsonl")
...
for seed in ["11", "42", "8"]:
    adapter = os.path.join(ROOT, f"experiments/cn_dental/runs/Qwen25_cn_v4_r16_lr2e4_s{seed}")
    ...
    print(f"  McNemar: b(学生对教师错)={b}, c(教师对学生错)={c}, 净胜 {b-c}, chi2={chi2:.3f}, p={p if p is not None else 'n/a'}")
